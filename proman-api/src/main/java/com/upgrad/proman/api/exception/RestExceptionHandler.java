...
public class RestExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> unauthorizedException(UnauthorizedException exe, WebRequest request){
        HttpStatus stat = exe.getCode().equals("USR-002")?HttpStatus.FORBIDDEN:
                ( exe.getCode().equals("ATH-002")?HttpStatus.UNAUTHORIZED:HttpStatus.NON_AUTHORITATIVE_INFORMATION );
